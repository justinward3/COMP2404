    ...
    while (1) {
        ...
        if (choice == 1) {
            ...
            if (cust != 0) {
                ...
                int year, milage;
                int vehicleoption;
                view.promptVehicleOptions(vehicleoption);
                ...
                //Truck
                  ...
                  (*cust) += factory.create(make, model, colour, year, milage,axle);
                }
                //Moto
                else if(vehicleoption==3){
                  string stringsidecar;
                  view.promptVehicleInfo(make, model, colour, year, milage, stringsidecar);
                  if(stringsidecar == "y"){
